...
class GoogleDriveHelper:
    ...
    def deletefile(self, link: str):
        try:
            ...
            msg = "Google Drive ID Could Not Found"
            return msg
        msg = ''
        try:
    ...
    def __upload_file(self, file_path, file_name, mime_type, parent_id):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'Uploaded by Jackssmit',
            'mimeType': mime_type,
        }
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if INDEX_URL is not None:
                    ...
                    if VIEW_LINK:
                        ...
                        urls = short_url(urls)
                        buttons.buildbutton("Team Cloud", urls)
    ...
    def cancel_download(self):
        ...
        if self.is_downloading:
            ...
            self.__listener.onDownloadError('⚡️Bro Your Processing Is Stop Man !')
