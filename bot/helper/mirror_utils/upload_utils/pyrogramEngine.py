...
class TgUploader:
    ...
    def upload(self):
        ...
        if self.__total_files <= self.__corrupted:
            return self.__listener.onUploadError('DUDE Files Corrupted. Check logs')
        LOGGER.info(f"⚡️ DUDE Leech Completed {self.name}")
                        ...
                        for leechchat in self.__leech_log:
                            ...
                            if BOT_PM:
                                try:
                                    ...
                                    LOGGER.error(f"Oops Failed To Send Video in Private:\n{err}")
                    else:
                        ...
                        for leechchat in self.__leech_log:
                            ...
                            if BOT_PM:
                                try:
                                    ...
                                    LOGGER.error(f"Oops Failed To Send Audio in Private:\n{err}")
                    else:
                        ...
                        for leechchat in self.__leech_log:
                            ...
                            if BOT_PM:
                                try:
                                    ...
                                    LOGGER.error(f"Oops Failed To Send Image in Private:\n{err}")
                    else:
                    ...
                    for leechchat in self.__leech_log:
                        ...
                        if BOT_PM:
                            try:
                                ...
                                LOGGER.error(f"Oops Failed To Send Document in Private:\n{err}")
                else:
    ...
    def cancel_download(self):
        ...
        LOGGER.info(f"Thanks God Cancelling Upload {self.name}")
        self.__listener.onUploadError('⚡️Bro Your Processing Is Stop Man !')
