...
def _clone(message, bot, multi=0):
    ...
    if is_gdrive_link(link):
        ...
        if STOP_DUPLICATE:
            ...
            if smsg:
                msg3 = "⚡️Cool Bro Someone Already Generate This !\nFile"
        ...
        if files <= 20:
            ...
            try:
                ...
                pass
        cc = f'\n\n<b>  </b>{tag}<b>  </b>\n\n<b> <i> Every moment is a fresh beginning </i></b>'
        ...
        sendMessage('DUDE Send Google Drive - GDTOT - AppDrive Link Along With CMD Or By Replying To The Link By CMD', bot, message)
